...
const Contact = () => {
  ...
  return (
    <div className='animate-onscroll-trigger md:flex w-full'>
      ...
      <div className='md:h-ful md:w-1/2 w-full md:my-0 my-5 bg-primaryColor flex flex-col justify-center items-center rounded-lg p-5'>
